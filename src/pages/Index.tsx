...
const Index = () => {
  ...
  const courses = [
    {
      title: "1 фрезой, комби, без переключения реверса",
      price: "15 000 ₽",
      features: ["Техника работы 1 фрезой", "Комбинированная обработка", "Без переключения реверса", "Сертификат"],
      icon: "Sparkles"
    },
    {
      title: "Гель, тонко, прочно",
      price: "7 500 ₽",
      features: ["Укрепление гелем тонко", "Прочное покрытие", "Профессиональная техника", "Естественный вид"],
      icon: "Zap"
    },
    {
      title: "Скорость, формула 3 в 1",
      price: "11 000 ₽",
      features: ["Скоростные техники", "Формула 3 в 1", "Экономия времени", "Секреты профи"],
      icon: "Award"
    }
  ];
